...
dtype_y = 'uint8'
model_fn = 'igipop_shrink.pkl'

img_size = 100
max_offset = 1
window = (img_size-2*max_offset, img_size-2*max_offset)

train_x, train_y, train_names = load_npys(which_set='train', image_size=img_size, resizing_method='shrink', seed=12)
valid_x, valid_y, valid_names = load_npys(which_set='valid', image_size=img_size, resizing_method='shrink', seed=12)
