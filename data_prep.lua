...
function normalizeImage(img)
    ...
    if w > CROP_SIZE or h > CROP_SIZE then
        ...
        cimg = image.crop(cimg, 1 + xOffset, 1 + yOffset, w + xOffset, h + yOffset)
    end
...
img = image.load[[/media/marat/MySSD/plankton/train/copepod_cyclopoid_copilia/30556.jpg]]
--img = image.load[[/media/marat/MySSD/plankton/train/acantharia_protist/79447.jpg]]
d(img)
d(normalizeImage(img))
d(img)
